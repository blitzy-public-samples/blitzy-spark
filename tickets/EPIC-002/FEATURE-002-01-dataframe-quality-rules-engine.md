...
| STORY-002-01-05 | Integrate Rules with Pipeline API | Backend | Allow ML engineers to embed quality validation as a QualityValidationStage within ML Pipelines, enabling schema-aware quality checks at any position in the pipeline with full save/load persistence support | [STORY-002-01-05-integrate-rules-with-pipeline-api.md](./FEATURE-002-01/STORY-002-01-05-integrate-rules-with-pipeline-api.md) |
