...
- **Edge Case 2 — Boundary Values:** When processing lag is exactly 60 seconds, classify as "Warning" (inclusive lower bound). When processing lag is exactly 300 seconds, classify as "Critical" (exclusive upper bound of Warning, inclusive lower of Critical). When lag exceeds 86,400 seconds (24 hours), display in "N days, Xh Ym" format instead of raw seconds.
