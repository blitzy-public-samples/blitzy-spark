...
class TaskMetrics private[spark] () extends Serializable {
  ...
  @transient private[spark] lazy val nameToAccums = LinkedHashMap(
    ...
    shuffleWrite.BUFFER_UTILIZATION_PERCENT -> shuffleWriteMetrics._bufferUtilizationPercent,
    shuffleWrite.SPILL_COUNT -> shuffleWriteMetrics._spillCount,
    shuffleWrite.BACKPRESSURE_EVENT_COUNT -> shuffleWriteMetrics._backpressureEventCount,
