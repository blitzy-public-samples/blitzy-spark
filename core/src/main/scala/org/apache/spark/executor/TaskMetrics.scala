...
class TaskMetrics private[spark] () extends Serializable {
  ...
  @transient private[spark] lazy val nameToAccums = LinkedHashMap(
    ...
    shuffleRead.STREAMING_BLOCKS_RECEIVED -> shuffleReadMetrics._streamingBlocksReceived,
    shuffleRead.CHECKSUM_FAILURES -> shuffleReadMetrics._checksumFailures,
    ...
    shuffleWrite.STREAMING_BUFFER_BYTES -> shuffleWriteMetrics._streamingBufferBytes,
    shuffleWrite.STREAMING_SPILL_COUNT -> shuffleWriteMetrics._streamingSpillCount,
    shuffleWrite.BACKPRESSURE_EVENTS -> shuffleWriteMetrics._backpressureEvents,
